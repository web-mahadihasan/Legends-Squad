...
const Navbar = ({claimCoin}) => {
 ...
 const toggleMenu = () => {
  ...
  return (
    <div className="relative z-30 w-full bg-white/90  lg:border-slate-200 backdrop-blur-xl ">
      <nav className="flex justify-between items-center container mx-auto px-4 py-5 gap-4">
